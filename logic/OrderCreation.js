...
const {
    sendOrder
} = require("../logic/ResponderService");
...
function createOrder(locations, resource, requiredQuantity) {
    ...
    if (remainingQuantity > 0) {
        ...
        return {
            ...
            message: `There is not enough capacity for ${resource} at any of the locations. Shortfall of ${remainingQuantity}.`
        };
    } else {
...
function createEvacuation(locations, impact) {
    ...
    if (remainingQuantity > 0) {
        ...
        return {
            ...
            message: `There is not enough capacity for Rest Center capacity at any of the locations. Requires space for ${remainingQuantity}.`
        };
    } else {
        // Return the order locations
        return {
...
// Set the disaster values values
